...
RSpec.describe ResortsController, :type => :controller do
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved resort as @resort" do
        post :create, {:resort => invalid_attributes}, valid_session
        expect(assigns(:resort)).to be_a_new(Resort)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested resort" do
        resort = Resort.create! valid_attributes
        put :update, {:id => resort.to_param, :resort => new_attributes}, valid_session
        resort.reload
    ...
    describe "with invalid params" do
      it "assigns the resort as @resort" do
        resort = Resort.create! valid_attributes
        put :update, {:id => resort.to_param, :resort => invalid_attributes}, valid_session
        expect(assigns(:resort)).to eq(resort)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the resorts list" do
      resort = Resort.create! valid_attributes
      delete :destroy, {:id => resort.to_param}, valid_session
      expect(response).to redirect_to(resorts_url)
    end
  end
